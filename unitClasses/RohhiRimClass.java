...
import com.intellekta.generics.middleearth.warriorTypes.RohhIrimAbstract;
import com.intellekta.generics.middleearth.warriorTypes.additionalTypes.HorseAbstract;

public class RohhiRimClass extends RohhIrimAbstract implements Cavalry {
    // внедрена статическая переменная для формирования постфикса имени при генерации случайных юнитов
    public static int countNameRohhIrim = 1;
    private int power;
    private HorseOfRohhIrim horse;
    ...
    public HorseOfRohhIrim getHorse() {
        return horse;
    }

    public RohhiRimClass(String name) {
        super(name);
        this.horse = new HorseOfRohhIrim();
    ...
    public class HorseOfRohhIrim extends HorseAbstract {
